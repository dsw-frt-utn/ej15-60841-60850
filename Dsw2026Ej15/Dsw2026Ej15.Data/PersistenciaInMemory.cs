...
public class PersistenciaInMemory : IPersistence
{
    ...
    public async Task InitializeDoctors()
    {
        ...
        var d1 = new Doctor("31b4fc6c - 8594 - 4b51 - 93a0 - 7b2432a51f89", "Joaquin Valdecantos", "MN-45213", true, s1);
        var d2 = new Doctor("31b4fc67 - 8594 - 4b51 - 93a0 - 7b2432a51f89", "Juan Tenreyro", "MM-45213", false, s2);
        var d3 = new Doctor("31b4fc62 - 8594 - 4b51 - 93a0 - 7b2432a51f89", "Tadeo Torres", "MR-45213", true, s3);
